                    ...
                    <div class="themesflat-options-control-inputs">
                        <div class="upload-dropzone">  
                            ...
                            <span class="upload-message <?php echo esc_attr($showupload);?> ">
                                <a href="#" class="browse-media"><?php esc_html_e( 'Add file', 'dirtywash' ) ?></a>
                                <a href="#" class="upload"></a>
                            </span>
                        </div>
                        <a href="#" class="button remove <?php echo esc_attr($showremove);?>"><?php esc_html_e( 'Remove', 'dirtywash' ) ?></a>
                    </div>
                ...
                <h6 class="themesflat-options-control-title"><?php themesflat_esc_html($title);?></h6>
                    <div class="themesflat-options-control-inputs">
                        <div class="upload-dropzone">
                            ...
                            <span class="upload-message <?php echo esc_attr($showupload);?> ">
                                <a href="#" class="browse-media"><?php esc_html_e( 'Add files', 'dirtywash' ) ?></a>
                                <a href="#" class="upload"></a>
                            </span>
                        </div>
                        <a href="#" class="button remove <?php echo esc_attr($showremove);?>"><?php esc_html_e( 'Remove', 'dirtywash' ) ?></a>
