 ...
 * @since 1.0.0
 */
class TFL_Gallery_Widget extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'TFL Gallery', 'elementor' );
	}
	...
	protected function render() {
		...
		<div class="elementor-image-gallery">
			...
			echo do_shortcode( '[gallery itemtag="div" ' . $this->get_render_attribute_string( 'shortcode' ) . ']' );
